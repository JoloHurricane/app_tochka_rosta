...
let upload = multer({dest:`./client/public/images/galleryCategory`})
let uploadImg = multer({dest:`./client/public/images/upload`})
...
router.post('/update/:id', async (req, res) => {
    try {
      ...
      fs.rename(`client/public/images/galleryCategory/${category.title}`,`client/public/images/galleryCategory/${title}`,()=>{console.log('callback rename')})
...
router.post('/delete/:id', async (req, res) => {
    try {
      ...
      const directory = `client/public/images/galleryCategory/${category.title}`
      fs.unlink(`client/public/images/galleryCategory/${category.img}`, (err) => {
      ...
      fs.rmdir(`client/public/images/galleryCategory/${category.title}`,()=>(console.log('deleted')))
  }) 
...
router.post('/create', 
  ...
  async (req, res) =>{
    try{
        const {title,description} = req.body
            ...
            await category.save()
            fs.mkdir(`client/public/images/galleryCategory/${category.title}`,()=>{console.log('add folder')})
            someId = category._id
  ...
  router.post('/upload-img', upload.single("file"),async(req,res)=>{
    try{
      ...
      fs.rename(`client/public/images/galleryCategory/${req.file.filename}`,"client/public/images/galleryCategory/"+fileName,()=>{console.log('callback rename')})
  ...
  router.post('/add-img', uploadImg.any(),async(req,res)=>{
    try{
     req.files.forEach(function(item,i,arr){
        ...
        fs.rename(`client/public/images/upload/${req.files[i].filename}`,`client/public/images/galleryCategory/${categoryG.title}/`+fileName,()=>{console.log('callback rename')})
     })
