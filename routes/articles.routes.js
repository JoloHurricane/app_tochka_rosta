...
let upload = multer({dest:`./client/public/images/articles`})
...
router.post('/delete/:id', async (req, res) => {
  try {
    ...
    if (article.img !=='placeholder.jpg'){
      fs.unlink(`client/public/images/articles/${article.img}`, (err) => {
...
router.post('/create', 
  ...
  router.post('/upload-img', upload.single("file"),async(req,res)=>{
    try{
      ...
      fs.rename(`client/public/images/articles/${req.file.filename}`,"client/public/images/articles/"+fileName,()=>{console.log('callback rename')})
